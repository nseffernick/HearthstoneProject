...
public class HasSummonSickness extends Enchantments {

    public HasSummonSickness(CanHaveEnchantments link) {
        super(Keywords.SUMMONSICKNESS, "Summon Sickness", link);
    }
